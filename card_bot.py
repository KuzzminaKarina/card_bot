...
bot = TeleBot(token='6305416506:AAEeTPU5OFFA-y7ai2Y6zwx85wPXj2Sb4Lw', parse_mode='html') # создание бота
...
# третий ряд кнопок
card_type_keybaord.row(
    types.KeyboardButton(text='Улыбнуться боту 😊'),
)
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        card_type = 'jcb'
    elif message.text == 'Улыбнуться боту 😊':
        bot.send_message(message.chat.id, '☺️ и тебе хорошего дня!')
        ...
        bot.send_message(
            ...
            text='Выбери платежную систему из предложенных :)'
        )
        return
